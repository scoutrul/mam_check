					...
					},
					{
						...
						items: [
							...
							},
							{
								id: 8,
								name:
									'Остается ли после мочеиспускания желание помочиться еще или Вы снова идете в туалет раньше, чем через 2 часа?',
								type: 'variant',
								answers: [
									{
										id: 1,
							...
							},
							{
								...
								answers: [
									...
									},
									{
										...
										type: 'variant',
										title:
											'Такое случается редко - не чаще 1 раза в месяц',
										weight: 1,
