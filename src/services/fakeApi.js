			...
			setTimeout(() => {
				const tests = [
					...
					},
					{
						id: 2,
						name:
							'Риск развития недостаточности мозгового кровообращения',
						shortDescription:
							'Тест на выявление проблем в мозговом кровообращении',
						description:
					...
					},
					{
						...
						shortDescription:
							'Тест на выявление возможных онкологий',
						description:
					...
					},
					{
						...
						shortDescription:
							'Тест на выявление проблем в органах дыхания',
						description:
					...
					},
					{
						...
						shortDescription:
							'Тест на выявление проблем моче-половой системы',
						description:
					...
					},
					{
						...
						shortDescription:
							'Тест на выявлений проблем с алкоголем',
						description:
					...
					},
					{
						...
						shortDescription:
							'Общий тест на определение состояния вашего здоровья',
						description:
				...
				const questions = [
					{
						...
						items: [
							...
							},
							{
								id: 8,
								name:
									'Возникают ли у Вас боль, ощущение тяжести, сдавления или жжения за грудиной или в левой половине грудной клетки во время подъма по лестрице, ходьбы быстрым шагом или при выходе на холод?',
								type: 'variant',
